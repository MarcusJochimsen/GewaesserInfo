    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Neues Gefahrenstelle erstellen <br><small>{{ $water->name }} in {{ $water->location }}</small></h3>
            </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        {{ Form::model('', ['route' => ['danger.store', 'water' => $water->id], 'class' => 'form-horizontal form-label-left']) }}
